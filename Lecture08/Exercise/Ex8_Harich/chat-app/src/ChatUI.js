...
class ChatUI {
    ...
    handleRegister(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield ApiService_js_1.ApiService.registerUser(name, email, pass, group);
                if (response.success) {
                    if (regResultDiv) {
    ...
    handleLogin(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield ApiService_js_1.ApiService.loginUser(usernameOrEmail, password);
                if (response.token) {
                    // Save the token in StateManager
                    StateManager_js_1.StateManager.setToken(response.token);
                    if (loginResultDiv) {
    ...
    handleGetUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield ApiService_js_1.ApiService.getUsers();
    ...
    handleSendMessage(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield ApiService_js_1.ApiService.sendMessage(senderId, receiverId, message);
                if (response.success) {
                    if (sendResultDiv)
